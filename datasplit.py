...
json.dump({"data": test.tolist(), "label": test_labels.tolist()}, open(str(cwd / "data" / "test.json"), "w+"))
json.dump({"data": train.tolist(), "label": train_labels.tolist()}, open(str(cwd / "data" / "train.json"), "w+"))


# Manual five fold Validation
