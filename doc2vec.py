...
d2v_model = Doc2Vec(documents, vector_size=64, min_count=1, workers=4, epochs=5)
...
grid_search = GridSearchCV(OneVsRestClassifier(SVC()), parameters, cv=5, n_jobs=8, verbose=10)
...
utils.saveModel({"preprocess": d2v_model,"model": grid_search.best_estimator_, "labelencoder": lb}, "D2V-512-OvR")